class TopBottomDraw {
    ...
    public static void main(String[] args) {
        ...
        int[] exampleDeck3 = new int[] {1, 3, 4, 3};
        ...
        System.out.printf("findBestScore returned %d, should be 6\n", tbp3.findBestScore(0, exampleDeck3.length - 1));
    }
