...
public class CompoundInterest {
    ...
    static double futureValue(double presentValue, double rate,
                              int targetYear) {
        return presentValue * java.lang.Math.pow((1 + rate * 0.01), numYears(targetYear));
    }
    ...
    static double futureValueReal(double presentValue, double rate,
        ...
        return futureValue(presentValue, rate, targetYear) * java.lang.Math.pow((1 - inflationRate * 0.01), numYears(targetYear));
    }
